var player = (function(ImgBlur, Mobile){
	...
	var songId = 0, singerId = 0, player_albumId = 0;
	...
	if(ImgBlur.glReady === true){
		...
		player_img.onload = function(){
			if(Mobile.isMobile()){
				ImgBlur.blur(player_img, 200, 200, mobile_rect_width, mobile_rect_height, 17, 70);
			}else{
				var rect = rectDOM.getBoundingClientRect();
				console.log(rect);
				ImgBlur.blur(player_img, 200, 200, rect.width, rect.height, 17, 70);
			}
